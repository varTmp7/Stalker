...
export class OrganizationService {
  ...
  // tslint:disable-next-line:max-line-length
  editOrganizations(organizationId: number, name: string, address: string, city: string, region: string, postalCode: string, nation: string,  phoneNumber: string, email: string, type: OrganizationType, ldapUrl?: string, ldapPort?: number, ldapCommonName?: string, ldapDomainComponent?: string): Observable<Organization> {
